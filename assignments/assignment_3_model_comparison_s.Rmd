...
```{r}
#removiung cortisol_saliva.
complex_model_3 <- lm(pain ~ age+ sex + STAI_trait+ pain_cat+ mindfulness + cortisol_serum, data= pain_data_clean)
...
# Refit model
new_complex_model_2 <- lm(pain ~ age+ sex + STAI_trait+ pain_cat+ mindfulness + cortisol_serum, data= pain_data_clean_2)
...
```{r}
#complex model
c_model <- lm(pain ~ age+ sex + STAI_trait+ pain_cat+ mindfulness + cortisol_serum, data= pain_data_clean_2)
summary(c_model)
#in a table format
tidy(c_model) %>%
  kable()
