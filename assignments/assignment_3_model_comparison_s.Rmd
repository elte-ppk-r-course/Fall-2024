...
library(lmtest)
# load the dataset
df <- read_xlsx("C:/Users/alizs/OneDrive/Desktop/M2 Tutorial/M2 Tutorialprojekt/assignment_3_dataset_.xlsx")
```
...
The Normal Q-Q plot of the standardized residuals shows the points closely following the straight line, indicating that the normality assumption is satisfied.
...
The serum and saliva cortisol measures both have VIF values above 5, indicating the presence of multicollinearity in the model. This is because the two cortisol measures are strongly correlated. Since serum cortisol is often regarded in medical research as more reliably related to stress, we'll drop the saliva cortisol masure from the model.
...
Including the psychological and hormone measures in the model improves our understanding of postoperative pain. We see that after including these variables, age and sex are no longer statistically significant predictors of pain. Instead, higher pain catastrophizing and higher serum cortisol levels are shown to be stronger predictors of higher levels of postoperative pain.
